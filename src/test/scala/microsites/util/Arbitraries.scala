...
trait Arbitraries {
  ...
  implicit def paletteMapArbitrary: Arbitrary[Map[String, String]] =
    Arbitrary {
      for {
  ...
  implicit def cdnDirectivesArbitrary: Arbitrary[CdnDirectives] =
    Arbitrary {
      for {
  ...
  implicit def hostingServiceArbitrary: Arbitrary[GitHostingService] =
    Arbitrary {
      oneOf(
  ...
  implicit def micrositeFaviconArbitrary: Arbitrary[MicrositeFavicon] =
    Arbitrary {
      for {
  ...
  implicit def micrositeEditButtonArbitrary: Arbitrary[Option[MicrositeEditButton]] =
    Arbitrary {
      for {
